...
## Brief overview
This repository is based on the original one by Wilson Ler ,but provides a handy 3D case to house all the electronics and migrate the code (detailed commented) to the Arduino Nano Every.
## Project components
